...
$id = $_GET["id"];
// query data
$ubah = query("SELECT * FROM transaksi_pengembalian WHERE id = $id")[0];
...
<body>
  ...
  <form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">Tanggal Peminjaman</label>
      <input type="date" class="form-control" id="tgl_pengembalian" name="tgl_pengembalian" value="<?= $ubah['tgl_pengembalian']; ?>">
    </div>
