...
$file = query("SELECT * FROM buku ORDER BY id DESC LIMIT $awalData, $jumlahDataPerhalaman");
// tombol cari di klik
				...
				<tbody>
					...
					<?php foreach ($file as $row) : ?>
						<tr>
							...
							<td><?= $row['rak']; ?></td>
							<td><img src="img/<?= $row['foto']; ?>" alt="gambar" style="width:100px;"></td>
						</tr>
						<?php $i++; ?>
					<?php endforeach; ?>
				</tbody>
				...
				<div class="modal-body">
					<form action="" method="post" enctype="multipart/form-data">
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="kode_buku" name="kode_buku" required="harus di isi">
						</div>
						<div class="mb-3">
						...
						<div class="mb-3">
							<p>Ketegori Buku</p>
							<input class="form-check-input" type="radio" name="kategori" id="umum" value="umum">
							<label class="form-check-label" for="umum">
								Umum
							</label>
							<input class="form-check-input" type="radio" name="kategori" id="novel" value="novel">
							<label class="form-check-label" for="novel">
								Novel
							</label>
							<input class="form-check-input" type="radio" name="kategori" id="pelajaran" value="pelajaran">
